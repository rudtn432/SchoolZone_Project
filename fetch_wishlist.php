...
// productWishlist 테이블에서 사용자가 찜한 상품 조회
$sql = "SELECT pi.product_id, pi.image_url, pi.title, pi.price, pi.is_sold
        FROM productWishlist pw
        JOIN productInfo pi ON pw.product_id = pi.product_id
        WHERE pw.user_id = ?";
